...
$answers = Answers::model ()->findAll ( array (
		"condition" => "department_id = " . UserLoginUtils::getRegisterInfo ()->dep_department_id 
) );
?>
<head>
<style>
		...
		<div class="portlet-body form">
			<div class="form-body">
				<div class="content_poll">
					...
					<p></p>
					<h3>1. การบริหารจัดการด้านความปลอดภัย อาชีวอนามัย
						และสถาพแวดล้อมในการทำงาน</h3>
					<h4>1.1 นโยบาย</h4>

					<div class="poll">
						<div class="num">1.1.1</div>
						<h2>นโยบายด้านความปลอดภัย ฯ ระดับส่วนงาน?</h2>
						<div class="choices">
							<div class="choice">
...
<a title="Download" class="fa fa-download"
								...
								<input type="hidden" name="tmpPath[1.1.1A]"
									value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.1.1A", "")?>">
<?php }?>
							...
							<div class="choice">
								...
								คาดว่าจะมีการดำเนินการเสร็จสิ้นภายใน<input
									id="answer_other_111A" name="answer_texts[1.1.1A]" type="text"
					...
					<div class="poll">
						...
						<h2>รูปแบบการประกาศนโยบายให้บุคลากรภายในส่วนงานรับทราบ?</h2>
						<div class="choices">
							<div class="choice">
								<input type="checkbox" value="1" name="answer_choices[1.1.2A]"
									id="answer_choices_3"
								...
								(เช่น หนังสือเวียน โปสเตอร์) <br> <input type="checkbox"
									value="1" name="answer_choices[1.1.2B]" id="answer_choices_4"
					...
					<br>
					<h4>1.2 โครงสร้างการบริหารจัดการด้านความปลอดภัยฯ
						บทบาทหน้าที่และความรับผิดชอบ ระดับส่วนงาน</h4>
					<div class="poll">
						<div class="num">1.2.1</div>
						<h2>
							โครงสร้างการบริหารจัดการด้านความปลอดภัยฯ?<input
						...
						<div class="choices">
							<div class="choice">
								**โปรดแนบไฟล์ดครงสร้างการบริหารจัดความปลอดภัยฯ /คำนั่งแต่งตั้ง**<label>
...
<a title="Download" class="fa fa-download"
								...
								<input type="hidden" name="tmpPath[1.2.1A]"
									value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.2.1A", "")?>">
<?php }?>
					...
					<div class="poll">
						...
						<h2>
							การประชุมคณะกรรมการความปลอดภัยฯ?<input id="answer_text_7"
								name="answer_texts[1.2.2]" type="text"
					...
					<div class="poll">
						...
						<h2>
							...
							(โปรดแนบไฟล์คำสั่งแต่งตั้ง)? <label> <input name="answer_files[]"
								type="file" style="display: none;"
								onchange='getFilename("1221",this)' /><a>&nbsp;&nbsp;<i
									class="fa fa-paperclip"></i></a></label> <input id="fpath_1221"
...
<a title="Download" class="fa fa-download"
							...
							<input type="hidden" name="tmpPath[1.2.2.1]"
								value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.2.2.1", "")?>">
<?php }?>
						...
						<div class="choices">
							...
							<div class="choice">
								โปรดระบุชื่อคณะกรรมการ <input id="answer_text_8"
									...
									id="answer_text_9" name="answer_texts[1.2.1.1.2]" type="text"
					...
					<div class="poll">
						...
						<h2>&nbsp;&nbsp;&nbsp;กรณีไม่มีคณะกรรมการความปลอดภัยฯ ?</h2>
						<div class="choices">
							<div class="choice">
								<input type="radio" value="1" name="answer_choices[1.2.2.2A]"
									id="rd1222A"
							...
							<div class="choice">
								<input type="radio" value="0" name="answer_choices[1.2.2.2A]"
									id="rd1222A"
					...
					<!-- END -->
					<h3>1.2.3 หน่วยงานความปลอดภัย/เจ้าหน้าที่ความปลอดภัย ประจำส่วนงาน</h3>
					<div class="poll">
						<div class="num">1.2.3.1</div>
						<h2>&nbsp;&nbsp;&nbsp;ส่วนงานมีหน่วยงานความปลอดภัยประจำส่วนงาน?</h2>
						<div class="choices">
							<div class="choice">
								<input type="radio" value="1" name="answer_choices[1.2.3.1A]"
									id="rd1231A"
							...
							<div class="choice">
								<input type="radio" value="0" name="answer_choices[1.2.3.1A]"
									id="rd1231A"
					...
					<div class="poll">
						...
						<h2>&nbsp;&nbsp;&nbsp;ส่วนงานมีเจ้าหน้าที่ความปลอดภัยประจำส่วนงาน?</h2>
						<div class="choices">
							<div class="choice">
								<input type="radio" value="1" name="answer_choices[1.2.3.2A]"
								...
								(โปรดแนบไฟล์คำสั่งแต่งตั้งเจ้าหน้าที่ปลอดภัย)<label> <input
									...
									onchange='getFilename("1232A",this)' /><a>&nbsp;&nbsp;<i
										class="fa fa-paperclip"></i></a></label> <input
									id="fpath_1232A" placeholder="" disabled="disabled"
									style="border: none;"
...
<a title="Download" class="fa fa-download"
								...
								<input type="hidden" name="tmpPath[1.2.3.2A]"
									value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.2.3.2A", "")?>">
<?php }?>
							...
							<div class="choice">
								<input type="radio" value="0" name="answer_choices[1.2.3.2A]"
									<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.2.3.2A", "0")?>
									id="rd1232A"> ไม่มี
								คาดว่าจะมีการดำเนินการเสร็จสิ้นภายใน<input id="answer_other_1232A"
									name="answer_texts[1.2.3.2B]" type="text"
					...
					<div class="poll">
						...
						<h2>ระบบการจัดการที่ได้รับการรับรอง?</h2>
						<div class="choices">
							<div class="choice">
								...
								(โปรดระบุ) <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
									...
									id="ck13A1">OHSAS 18001&nbsp;&nbsp;&nbsp;&nbsp; ปีที่ได้รับ <input
									id="answer_other_13A1" name="answer_texts[1.3A.1]"
									value="<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::TEXT_TYPE,"1.3A.1", "") ?>"
									type="text" style="border: none; border-bottom-style: dotted;">
								<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
					...
					<h3>2. แผนงานและแนวทางการดำเนินงานความมปลอดภัยฯ</h3>
					<div class="poll">
						<div class="num">2.1</div>
						<h2>ปัญหาด้านความปลอดภัย อาชีวอนามัย
							และสภาพแวดล้อมในการทำงานระดับส่วนงาน (โปรดระบุ)?</h2>
						<div class="choices">
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>แผนงาน/โครงการ/กิจกรรม และแนวทางการดำเนินงานด้านความปลอดภัย ฯ
							ระดับส่วนงาน?</h2>
						<div class="choices">
							<div class="choice">
								...
								และแนวทางการดำเนินงานด้านความปลอดภัย ฯ ** <label> <input
									...
									onchange='getFilename("22A",this)' /><a>&nbsp;&nbsp;<i
										class="fa fa-paperclip"></i></a></label> <input id="fpath_22A"
									placeholder="" disabled="disabled" style="border: none;"
...
<a title="Download" class="fa fa-download"
								...
								<input type="hidden" name="tmpPath[2.2A]"
									value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "2.2A", "")?>">
<?php }?>
					...
					<!-- END -->
					<h3>การเฝ้าระวังด้านสิ่งแวดล้อมและสุขภาพ</h3>
					<div class="poll">
						<div class="num">2.3.1</div>
						<h2>การตรวจวัดสภาพแวดล้อมในการทำงาน?</h2>
						<div class="choices">
							<div class="choice">
								<input type="radio" value="1" name="answer_choices[2.3.1A]"
									...
									id="rd231A"> มีการตรวจวัดสภาพแวดล้อมในการทำงาน
								(โปรดระบุ) <br>
								...
								<table>
									<tr>
										...
										<td><input id="answer_other_231A" name="answer_texts[2.3.1A]"
											type="text"
					...
					<!-- END -->
					<h3>2.3.2 การตรวจสุขภาพของบุคลากร</h3>
					<div class="poll">
						<div class="num">2.3.2.1</div>
						<h2>&nbsp;&nbsp;&nbsp;&nbsp;ส่วนงานได้จัดให้มีการตรวจสุขภาพประจำปี?</h2>
						<div class="choices">
							<div class="choice">
								<input type="radio" value="1" name="answer_choices[2.3.2.1A]"
								...
								หรือแนบไฟล์ตามที่ส่วนงานมีการจัดเก็บข้อมูล) <br>จำนวนบุคลากรทั้งหมดภายในส่วนงาน<input
									...
									type="text" style="border: none; border-bottom-style: dotted;">คน
								<br>จำนวนบุคลากรที่ตรวจสุขภาพ<input id="answer_other_2321A2"
									value=" <?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::TEXT_TYPE,"2.3.2.1A.2", "")?>"
									name="answer_texts[2.3.2.1A.2]" type="text"
									style="border: none; border-bottom-style: dotted;">คน <br> <br>
								<table id="gvResult" border="1">
									<thead>
										<tr>
								...
								<table>
									<tr>
										<td>บริษัท/หน่วยงานที่ตรวจวัด (โปรดระบุ)</td>
										<td><input id="answer_other_2321A10" name="answer_texts[2.3.2.1A.10]"
											type="text"
							...
							<div class="choice">
								<input type="radio" value="0" name="answer_choices[2.3.2.1A]"
					...
					<div class="poll">
						...
						<h2>&nbsp;&nbsp;&nbsp;&nbsp;การตรวจสุขภาพตามปัจจัยเสี่ยง?</h2>
						<div class="choices">
							<div class="choice">
								<input type="radio" value="1" name="answer_choices[2.3.2.2A]"
								...
								<table id="gvResult" border="1">
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align: center;">&nbsp;&nbsp;&nbsp;<input
												id="answer_other_2322A10" name="answer_texts[2.3.2.2A.10]"
												type="text"
							...
							<div class="choice">
								<input type="radio" value="0" name="answer_choices[2.3.2.2A]"
					...
					<h3>3. การดำเนินงาน/กิจกรรมด้านความปลอดภัย ฯ</h3>
					<h4>3.1 การฝึกอบรม
						การสร้างจิตสำนักและความรู้ความสามารถด้านความปลอดภัย ฯ</h4>

					<div class="poll">
						<div class="num">3.1.1</div>
						<h2>มีการฝึกอบรม
							เพื่อสร้างจิตสำนึกและความรู้ความสามารถด้านความปลอดภัย ฯ?</h2>
						<div class="choices">
							<div class="choice">
...
<a title="Download" class="fa fa-download"
								...
								<input type="hidden" name="tmpPath[3.1.1A]"
									value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "3.1.1A", "")?>">
<?php }?>
					...
					<div class="poll">
						...
						<h2>มีการทบทวนความรู้ด้านความปลอดภัย ฯ
							ให้กับผู้ปฏิบัติงานอย่างน้อยปีละ 1 ครั้ง?</h2>
						<div class="choices">
							<div class="choice">
					...
					<h4>3.2 ข้อคิดเห็น ข้อเสนอแนะ ข้อร้องเรียนด้านความปลอดภัย ฯ</h4>
					<div class="poll">
						<div class="num">3.2.1</div>
						<h2>ส่วนงานมีช่องทางสำหรับบุคลากร
					...
					<div class="poll">
						...
						<h2>ส่วนงานมีช่องทางสำหรับบุคลากร
							นักศึกษาหรือบุคลากรภายนอกร้องเรียนด้านความปลอดภัยฯ?</h2>
						<div class="choices">
							<div class="choice">
					...
					<h4>3.3 เอกสารด้านความปลอดภัย ฯ และการทบทวน</h4>

					<div class="poll">
						<div class="num">3.3.1</div>
						<h2>ส่วนงานมีการจัดเก็บข้อมูลและเอกสารด้านความปลอดภัย ฯ
							ในรูปแบบใดและมีความถี่ในการทบทวนอย่างไร ในแต่ละเรื่องต่อไปนี้?</h2>
						<div class="choices">
							<div class="choice">
								...
								<table id="gvResult" border="1">
									...
									<tbody>
										<tr>
											...
											<td style="text-align: center;"><input id="answer_text_29"
												name="answer_texts[3.3.1.1D]" type="text"
										...
										<tr>
											...
											<td style="text-align: left;"><input type="checkbox"
												...
												id="answer_choices_5">อิเล็กทรอนิกส์</td>
											<td style="text-align: center;"><input id="answer_text_29"
												name="answer_texts[3.3.1.2D]" type="text"
										...
										<tr>
											...
											<td style="text-align: left;"><input type="checkbox"
												...
												id="answer_choices_5">อิเล็กทรอนิกส์</td>
											<td style="text-align: center;"><input id="answer_text_29"
												name="answer_texts[3.3.1.3D]" type="text"
										...
										<tr>
											...
											<td style="text-align: left;"><input type="checkbox"
												...
												id="answer_choices_5">อิเล็กทรอนิกส์</td>
											<td style="text-align: center;"><input id="answer_text_29"
												name="answer_texts[3.3.1.4D]" type="text"
										...
										<tr>
											...
											<td style="text-align: left;"><input type="checkbox"
												...
												id="answer_choices_5">อิเล็กทรอนิกส์</td>
											<td style="text-align: center;"><input id="answer_text_29"
												name="answer_texts[3.3.1.5D]" type="text"
										...
										<tr>
											...
											<td style="text-align: left;"><input type="checkbox"
												...
												id="answer_choices_5">อิเล็กทรอนิกส์</td>
											<td style="text-align: center;"><input id="answer_text_29"
												name="answer_texts[3.3.1.6D]" type="text"
										...
										<tr>
											...
											<td style="text-align: left;"><input type="checkbox"
												...
												id="answer_choices_5">อิเล็กทรอนิกส์</td>
											<td style="text-align: center;"><input id="answer_text_29"
												name="answer_texts[3.3.1.7D]" type="text"
										...
										<tr>
											...
											<td style="text-align: left;"><input type="checkbox"
												...
												id="answer_choices_5">อิเล็กทรอนิกส์</td>
											<td style="text-align: center;"><input id="answer_text_29"
												name="answer_texts[3.3.1.8D]" type="text"
										...
										<tr>
											...
											<td style="text-align: left;"><input type="checkbox"
												...
												id="answer_choices_5">อิเล็กทรอนิกส์</td>
											<td style="text-align: center;"><input id="answer_text_29"
												name="answer_texts[3.3.1.9D]" type="text"
										...
										<tr>
											...
											<td style="text-align: left;"><input type="checkbox"
												...
												id="answer_choices_5">อิเล็กทรอนิกส์</td>
											<td style="text-align: center;"><input id="answer_text_29"
												name="answer_texts[3.3.1.10D]" type="text"
										...
										<tr>
											...
											<td style="text-align: left;"><input type="checkbox"
												...
												id="answer_choices_5">อิเล็กทรอนิกส์</td>
											<td style="text-align: center;"><input id="answer_text_29"
												name="answer_texts[3.3.1.11E]" type="text"
					...
					<h4>3.4 การควบคุมการปฏิบัติงาน</h4>
					<div class="poll">
						<div class="num">3.4.1</div>
						<h2>ส่วนงานมีการควบคุมการปฎิบัติงานในเรื่องการจัดซื้อจัดจ้าง
							ดังต่อไปนี้?</h2>
						<div class="choices">
							<div class="choice">
								...
								<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
									...
									id="ck341A7">อื่น ๆ โปรดระบุ <input id="answer_choices_341A7"
									name="answer_texts[3.4.1A.7]" type="text"
					...
					<h4>3.5 การเตรียมความพร้อมและการตอบโต้ภาวะฉุกเฉิน</h4>
					<div class="poll">
						<div class="num">3.5.1</div>
						<h2>
							ส่วนงานมีการจัดทำแผนโต้ตอบภาวะฉุกเฉิน/การทบทวน/
							(โปรดแนบไฟล์แผนโต้ตอบภาวะฉุกเฉิน)? <label> <input
								name="answer_files[]" type="file" style="display: none;"
								onchange='getFilename("351",this)' /><a>&nbsp;&nbsp;<i
									class="fa fa-paperclip"></i></a></label> <input id="fpath_351"
								placeholder="" disabled="disabled" style="border: none;"
...
<a title="Download" class="fa fa-download"
							...
							<input type="hidden" name="tmpPath[3.5.1]"
								value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "3.5.1", "")?>">
<?php }?>
					...
					<div class="poll">
						...
						<h2>ส่วนงานมีการฝึกอบรมแผนการ โต้ตอบภาวะฉุกเฉิน?</h2>
						<div class="choices">
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>ส่วนงานมีการฝึกซ้อมแผนการโต้ตอบฉุกเฉิน?</h2>
						<div class="choices">
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>การตรวจสอบอุปกรณ์และเส้นทางที่ใช้ในภาวะฉุกเฉิน?</h2>
						<div class="choices">
							<div class="choice">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
									...
									id="ck354AA">ทั้งส่วนงาน <input type="checkbox"
									value="1" name="answer_choices[3.5.4A.B]"
									...
									id="answer_text_354AB" name="answer_texts[3.5.4A.B]" type="text"
									style="border: none; border-bottom-style: dotted;"> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-วันที่จัดการฝึกอบรม
					...
					<h3>4. การะประเมินผลและการทบทวนการจัดการ</h3>

					<div class="poll">
						<div class="num">4.1</div>
						<h2>การตรวจประเมินด้านความปลอดภัย ฯ</h2>
						<div class="choices">
							<div class="choice">
					...
					<h4>4.2 รายงานการเกิดอุบัติเหตุและการสอบสวนอุบัติเหตุ</h4>
					<div class="poll">
						<div class="num">4.2.1</div>
						<h2>ส่วนงานมีระบบการแจ้งเหตุหรือการรายงานเกิดอุบัติเหตุ?</h2>
						<div class="choices">
							<div class="choice">
								...
								<input type="checkbox" value="1" name="answer_choices[4.2.1A.2]"
							...
							** โปรดแนบไฟล์รายงานการเกิดอุบัติเหตุ** <label> <input
								...
								onchange='getFilename("421A",this)' /><a>&nbsp;&nbsp;<i
									class="fa fa-paperclip"></i></a></label> <input id="fpath_421A"
								placeholder="" disabled="disabled" style="border: none;"
...
<a title="Download" class="fa fa-download"
							...
							<input type="hidden" name="tmpPath[4.2.1A]"
								value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "4.2.1A", "")?>">
<?php }?>
					...
					<div class="poll">
						...
						<h2>ความถี่ในการเกิดอุบัติเหตุ?</h2>
						<div class="choices">
							<div class="choice">
								<input id="answer_text_29" name="answer_texts[4.2.2]"
									...
									type="text" style="border: none; border-bottom-style: dotted;">ครั้ง/ปี
							</div>
							<div class="choice"></div>
						</div>
					</div>
					...
					<div class="poll">
						...
						<h2>ความเสียหายจากการเกิดอุบัติเหตุ?</h2>
						<div class="choices">
							<div class="choice">
								<input type="checkbox" value="1" name="answer_choices[4.2.3A]"
									...
									type="text" style="border: none; border-bottom-style: dotted;">คน/ปี
								<br> <input type="checkbox" value="1"
									name="answer_choices[4.2.3B]"
									<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"4.2.3B", "1")?>
									id="ck423B">บาดเจ็บ/เจ็บป่วย จำนวน <input id="answer_text_423B"
									name="answer_texts[4.2.3B]"
								...
								<br> <input type="checkbox" value="1"
									...
									id="ck423C">ทรัพย์สินเสียหาย จำนวน <input id="answer_text_423C"
									name="answer_texts[4.2.3C]"
					...
					<div class="poll">
						...
						<h2>ส่วนงานมีการรายงานการสอบสวนอุบัติเหตุ?</h2>
						<div class="choices">
							<div class="choice">
								<input type="radio" value="1" name="answer_choices[4.2.4A]"
									...
									id="answer_choices_3">มี (โปรดแนบไฟล์เอกสารการรายงาน)<label> <input
									name="answer_files[]" type="file" style="display: none;"
									onchange='getFilename("424A",this)' /><a>&nbsp;&nbsp;<i
										class="fa fa-paperclip"></i></a></label> <input
									id="fpath_424A" placeholder="" disabled="disabled"
									style="border: none;"
...
<a title="Download" class="fa fa-download"
								...
								<input type="hidden" name="tmpPath[4.2.4A]"
									value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "4.2.4A", "")?>">
<?php }?>
					...
					<div class="poll">
						...
						<h2>ส่วนงานมีมาตราการ/วิธีการดำเนินการแก้ไขและป้องกันการเกิดซ้ำ?</h2>
						<div class="choices">
							<div class="choice">
								<input type="radio" value="1" name="answer_choices[4.2.5A]"
									...
									id="answer_choices_3">มี (โปรดแนบไฟล์เอกสารการรายงาน)<label> <input
									name="answer_files[]" type="file" style="display: none;"
									onchange='getFilename("425A",this)' /><a>&nbsp;&nbsp;<i
										class="fa fa-paperclip"></i></a></label> <input
									id="fpath_425A" placeholder="" disabled="disabled"
									style="border: none;"
...
<a title="Download" class="fa fa-download"
								...
								<input type="hidden" name="tmpPath[4.2.5A]"
									value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "4.2.5A", "")?>">
<?php }?>
