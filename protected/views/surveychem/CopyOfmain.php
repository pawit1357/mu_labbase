<?php
$answers = Answers::model ()->findAll ( array ("condition" => "department_id = ".UserLoginUtils::getRegisterInfo ()->dep_department_id ));
?>
<head>
<style>
.content_poll {
		...
		<div class="portlet-body form">
			<div class="form-body">
				<div class="content_poll">
					...
					<p></p>
					<h3>1 การทำงานกับสารเคมี</h3>
					<h4>1.1 การบริการจัดการด้านความปลอดภัยทางเคมี</h4>
					<!-- 1.1 -->

					<div class="poll">
						<div class="num">1.1.1</div>
						<h2>มีการแต่งตั้งคณะกรรมการที่กำกับดูแลงานด้านความปลอดภัยทางเคมี?</h2>
						<div class="choices">
							<div class="choice">
								<input type="radio" value="1" name="answer_choices[1.1.1A]"
								 <?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.1.1A", "1")?>
									id="rd111A">ไม่มี
								คาดว่าจะมีการดำเนินการเสร็จสิ้นภายใน <input id="answer_text_111A"
									name="answer_texts[1.1.1A]" type="text"
							...
							<div class="choice">
								...
								<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.1.1A", "0")?>
									id="rd111A">มี (โปรดแนบสำเนาคำสั่งแต่งตั้งคณะกรรมการ)
...
<input id="fpath_111A" placeholder="" disabled="disabled" style="border: none;" value="<?php echo QuestionUtil::getAnswerValue($answers, "4", "1.1.1A", "")?>" />
<?php if(QuestionUtil::getAnswerValue($answers, "4", "1.1.1A", "") != ''){?>
<a title="Download" class="fa fa-download" href="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.1.1A", "")?>"></a>
<input type="hidden" name="tmpPath[1.1.1A]" value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.1.1A", "")?>">
<?php }?>
					...
					<div class="poll">
						...
						<h2>มีแผนงานความปลอดภัยทางเคมีที่ครอบคลุ่มด้านต่าง ?</h2>
						<div class="choices">
							<div class="choice">
								...
								<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.1.2A", "1")?>
									id="rd112A">ไม่มีแผน
								คาดว่าจะมีการดำเนินการเสร็จสิ้นภายใน <input id="answer_text_112A"
							...
							<div class="choice">
								...
								<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
									...
									name="answer_texts[1.1.2B.5]" type="text" id="answer_text_112B5"
					...
					<div class="poll">
						...
						<h2>ส่วนงานมีการจัดทำเอกสารด้านความปลอดภัยในห้องปฏิบัติการ?</h2>
						<div class="choices">
							<div class="choice">
								...
								<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.1.3A", "1")?>
									id="rd113A">ไม่มี
								คาดว่าจะมีการดำเนินการเสร็จสิ้นภายใน <input id="answer_text_113A"
									name="answer_texts[1.1.3A]" type="text"
							...
							<div class="choice">
								...
								<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.1.3A", "0")?>
									...
									id="ck113B4">อื่น ๆ โปรดระบุ <input
									id="answer_text_113B4" name="answer_texts[1.1.3B.4]" type="text"
					...
					<!-- 1.2 -->
					<h4>1.2 การบริหารจัดการของเสียสารเคมี</h4>
					<div class="poll">
						<div class="num">1.2.1</div>
						<h2>มีระบบบันทึกข้อมูลของเสียสารเคมีที่เกิดขึ้นในส่วนงาน?</h2>
						<div class="choices">
							<div class="choice">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เอกสาร <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
					...
					<div class="poll">
						...
						<h2>มีการจัดทำรายงานสรุปผลข้อมูลของเสียสารเคมีที่เกิดขึ้นในส่วนงาน?</h2>
						<div class="choices">
							<div class="choice">
							...
							<div class="choice">
								...
								(โปรดแนบรายงานสรุปผลข้อมูลประเภทและปริมาณของเสียสารเคมีประจำปี)<label>
									<input name="answer_files[]" type="file" style="display: none;" onchange='getFilename("122A",this)'	 /><a>&nbsp;&nbsp;<i
										class="fa fa-paperclip"></i></a>
										
<input id="fpath_122A" placeholder="" disabled="disabled" style="border: none;" value="<?php echo QuestionUtil::getAnswerValue($answers, "4", "1.2.2A", "")?>" />
<?php if(QuestionUtil::getAnswerValue($answers, "4", "1.2.2A", "") != ''){?>
<a title="Download" class="fa fa-download" href="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.2.2A", "")?>"></a>
<input type="hidden" name="tmpPath[1.2.2A]" value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.2.2A", "")?>">
<?php }?>
								</label>
							</div>
						</div>
					...
					<div class="poll">
						...
						<h2>มีการจัดแยกประเภทของเียสารเคมีตามเกณฑ์ของมหาวิทยาลัยมหิดล (MU
							ChemWaste)?</h2>
						<div class="choices">
							<div class="choice">
							...
							<div class="choice">
								...
								<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.2.3A", "0")?>
									...
									id="answer_text_123A" name="answer_texts[1.2.3A]" type="text"
					...
					<div class="poll">
						...
						<h2>มีการแยกพื้นที่จัดกเก็บของเสียสารเคมีที่เหมาะสมและมีป้ายระบุอันตรายอย่างชัดเจน?</h2>
						<div class="choices">
							<div class="choice">
							...
							<div class="choice">
								...
								<input type="checkbox" value="1" name="answer_choices[1.2.4B.1]"
								...
								<input type="checkbox" value="1" name="answer_choices[1.2.4B.2]"
								...
								**โปรดระบุตำแหน่งพื้นที่จัดเก็บพร้อมแนบภาพประกอบ** <label> <input
									name="answer_files[]" type="file" style="display: none;" onchange='getFilename("124B2",this)'	 /><a>&nbsp;&nbsp;<i
										class="fa fa-paperclip"></i></a></label>
										
<input id="fpath_124B2" placeholder="" disabled="disabled" style="border: none;" value="<?php echo QuestionUtil::getAnswerValue($answers, "4", "1.2.4B.2", "")?>" />
<?php if(QuestionUtil::getAnswerValue($answers, "4", "1.2.4B.2", "") != ''){?>
<a title="Download" class="fa fa-download" href="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.2.4B.2", "")?>"></a>
<input type="hidden" name="tmpPath[1.2.4B.2]" value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.2.4B.2", "")?>">
<?php }?>
							</div>
						</div>
					</div>
					...
					<div class="poll">
						...
						<h2>มีผู้รับผิดชอบ/หน่วยงานที่ดูแลเรื่องการบริหารจัดการของเสียสารเคมี?</h2>
						<div class="choices">
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>มีการกำหนดแนวปฏิบัติในการบริหารจัดการของเสียสารเคมีระดับส่วนงาน?</h2>
						<div class="choices">
							<div class="choice">
							...
							<div class="choice">
								...
								<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.2.6A", "0")?>
									...
									name="answer_files[]" type="file" style="display: none;" onchange='getFilename("126A",this)'	 /><a>&nbsp;&nbsp;<i
										class="fa fa-paperclip"></i></a></label>
										
<input id="fpath_126A" placeholder="" disabled="disabled" style="border: none;" value="<?php echo QuestionUtil::getAnswerValue($answers, "4", "1.2.6A", "")?>" />
<?php if(QuestionUtil::getAnswerValue($answers, "4", "1.2.6A", "") != ''){?>
<a title="Download" class="fa fa-download" href="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.2.6A", "")?>"></a>
<input type="hidden" name="tmpPath[1.2.6A]" value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.2.6A", "")?>">
<?php }?>
							</div>
						</div>
					</div>
					...
					<div class="poll">
						...
						<h2>มีแนวทางปฏิบัติหรือมาตราการในการลดการเกิดของเสียสารเคมีในห้องปฏิบัติการ/ส่วนงาน?</h2>
						<div class="choices">
							<div class="choice">
							...
							<div class="choice">
								...
								วิธีการ/มาตราการลดการเกิดของเสียสารเคมี** <label> <input
									name="answer_files[]" type="file" style="display: none;" onchange='getFilename("127A",this)'	 /><a>&nbsp;&nbsp;<i
										class="fa fa-paperclip"></i></a></label>
										
<input id="fpath_127A" placeholder="" disabled="disabled" style="border: none;" value="<?php echo QuestionUtil::getAnswerValue($answers, "4", "1.2.7A", "")?>" />
<?php if(QuestionUtil::getAnswerValue($answers, "4", "1.2.7A", "") != ''){?>
<a title="Download" class="fa fa-download" href="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.2.7A", "")?>"></a>
<input type="hidden" name="tmpPath[1.2.7A]" value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "1.2.7A", "")?>">
<?php }?>
					...
					<div class="poll">
						...
						<h2>การส่งของเสียสารเคมีไปกำจัดโดย?</h2>
						<div class="choices">
							<div class="choice">
								บริษัท <input id="answer_text_34" name="answer_texts[1.2.8.1]"
								...
								ปีละ <input id="answer_text_35" name="answer_texts[1.2.8.2]"
					...
					<div class="poll">
						...
						<h2>ค่าใช้จ่ายในการส่งกำจัดของเสียสารเคมี?</h2>
						<div class="choices">
							<div class="choice">
					...
					<!-- 1.3 -->
					<h4>1.3 ระบบตรวจติดตาม / ประเมินผล</h4>
					<div class="poll">
						<div class="num">1.3.1</div>
						<h2>มีห้องปฏิบัติการวิทยาศาสตร์ทางเคมีจำนวน?</h2>
						<div class="choices">
							<div class="choice">
								...
								value="<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::TEXT_TYPE,"1.3.1", "")?>"
									type="text" style="border: none; border-bottom-style: dotted;">ห้อง
							</div>
							<div class="choice"></div>
						</div>
					</div>
					...
					<div class="poll">
						...
						<h2>มีระบบตรวจติดตามเพื่อให้เกิดความปลอดภัยในห้องปฏิบัติการวิทยาศาสตร์ทางเคมี?</h2>
						<div class="choices">
							<div class="choice">
							...
							<div class="choice">
								<input type="radio" value="0" name="answer_choices[1.3.2A]"
									...
									value="	<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::TEXT_TYPE,"1.3.2B.1A", "")?>"
									 type="text"
									style="border: none; border-bottom-style: dotted;">ครั้ง / ปี <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
					...
					<div class="poll">
						...
						<h2>ห้องปฏิบัติการวิทยาศาสตร์ทางเคมีที่มีการตรวจประเมินด้านความปลอดภัย?</h2>
						<div class="choices">
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>มีการนำข้อมูลจากการตรวจติดตามมาใช้วิเคราะห์และจัดทำแผนพัฒนายกระดับความปลอดภัยในห้องปฏิบัติการทางเคมี
					...
					<!-- 1.4 -->
					<h4>1.4 ระบบการจัดการเครื่องมือที่ใช้ในห้องปฏิบัติการ</h4>
					<div class="poll">
						<div class="num">2.3.1</div>
						<h2>มีระบบการตรวจสอบเครื่งมือให้มีความปลอดภัยและพร้อมใช้งาน?</h2>
						<div class="choices">
							<div class="choice">
					...
					<!-- 1.5 -->
					<h4>1.5 การรายงานการเกิดอุบัติเหตุที่เกี่ยวข้องกับการใช้สารเคมี
						หรือที่เกิดขึ้นในห้องปฏิบัติการทางวิทยาศาสตร์ทางเคมี</h4>

					<div class="poll">
						<div class="num">1.5.1</div>
						<h2>มีระบบการแจ้งเหตุ หรือการรายงานการเกิดอุบัติเหตุ?</h2>
						<div class="choices">
							<div class="choice">
							...
							<div class="choice">
								...
								<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.5.1A", "0")?>
									...
									id="answer_text_151B2" name="answer_texts[1.5.1B.2]" type="text"
					...
					<div class="poll">
						...
						<div class="choices">
							<div class="choice">
								...
								จำนวน <input id="answer_text_54" name="answer_texts[1.5.3.2]"
								value="<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::TEXT_TYPE,"1.5.3.2", "")?>"
									type="text" style="border: none; border-bottom-style: dotted;">ราย/ปี
								<br>ทรัพย์สินเสียหาย จำนวน <input id="answer_text_55"
					...
					<div class="poll">
						...
						<h2>มีรายงานการสอบสวนอุบัติเหตุ?</h2>
						<div class="choices">
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>มีมาตรการ/วิธีการการดำเนินการแก้ไขและป้องกันการเกิดซ้ำ?</h2>
						<div class="choices">
							<div class="choice">
					...
					<!-- 1.6 -->
					<h4>1.6 การบริหารจัดการความเสี่ยง</h4>

					<div class="poll">
						<div class="num">1.6.1</div>
						<h2>มีการประเมินความเสี่ยงครอบคลุมเรื่องต่อไปนี้
							(พร้อมแนบแบบประเมินความเสี่ยง)?</h2>
						<div class="choices">
							<div class="choice">
								<input type="checkbox" value="1" name="answer_choices[1.6.1.1]"
								<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.6.1.1", "1")?>
									id="answer_choices_60">สารเคมี การใช้ การเก็บ และการทิ้ง <br> <input
									type="checkbox" value="1" name="answer_choices[1.6.1.2]"
									<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.6.1.2", "1")?>
									id="answer_choices_61">ผลกระทบด้านสุขภาพจากการทำงานกับสารเคมี <br>
								<input type="checkbox" value="1" name="answer_choices[1.6.1.3]"
								...
								<br> <input type="checkbox" value="1"
									...
									id="answer_choices_63">เครื่องมือที่ใช้ในการทำงาน
								<br> <input type="checkbox" value="1"
									name="answer_choices[1.6.1.5]" 
					...
					<div class="poll">
						...
						<h2>มีการนำข้อมูลจากรายงานการบริหารความเสี่ยงมาใช้ประโยชน์?</h2>
						<div class="choices">
							<div class="choice">
								<input type="checkbox" value="1" name="answer_choices[1.6.2.1]"
								...
								(Standard Operating Procedure) <br> <input type="checkbox"
									...
									id="answer_choices_66">การสอน
								แนะนำ อบรมแก่ผู้ปฏิบัติงาน <br> <input type="checkbox" value="1"
									name="answer_choices[1.6.2.3]" 
									<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::CHECKBOX_TYPE,"1.6.2.3", "1")?>
									id="answer_choices_67">การประเมินผล
								ทบทวน และวางแผนปรับปรุง การบริหารความเสี่ง <br> <input
									type="checkbox" value="1" name="answer_choices[1.6.2.4]"
					...
					<div class="poll">
						...
						<h2>มีเอกสาร บันทึก ข้อมูลต่อไปนี้อยู่ในห้องปฏิบัติการ?</h2>
						<div class="choices">
							<div class="choice">
								...
								<input
									type="checkbox" value="1" name="answer_choices[1.6.3.2]"
