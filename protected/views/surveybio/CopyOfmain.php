		...
		<div class="portlet-body form">
			<div class="form-body">
				<div class="content_poll">
					<h3>2 การทำงานด้านความปลอดภัยทางชีวภาพ</h3>
					<h4>2.1 การบริหารจัดการด้านความปลอดภัยทางชีวภาพ</h4>
					<div class="poll">
						<div class="num">2.1.1</div>
						<h2>มีการแต่งตั้งคณะกรรมการความปลอดภัยทางชีวภาพ ระดับส่วนงาน
							(Institute Biosafety Committee; IBC-ส่วนงาน)</h2>
...
<a title="Download" class="fa fa-download"
									...
									<input type="hidden" name="tmpPath[2.1.1A]"
										value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "2.1.1A", "")?>">
<?php }?>
								...
								<div class="choice">
									...
									คาดว่าจะมีการดำเนินการเสร็จสิ้นภายใน <input
										id="answer_text_211A" name="answer_texts[2.1.1A]" type="text"
					...
					<div class="poll">
						...
						<h2>มีเจ้าหน้าที่ความปลอดภัยทางชีวภาพ (Biosafety Officer; BSO)
							หรือผู้รับผิดชอบดูแลงานด้านความปลอดภัยทางชีวภาพ</h2>
					...
					<div class="poll">
						...
						<h2>มีแผนงานด้านความปลอดภัยทางชีวภาพที่ครอบคลุมด้านต่าง ๆ?</h2>
						<div class="choices">
							<div class="choice">
							...
							<div class="choice">
								...
								คาดว่าจะมีการดำเนินการเสร็จสิ้นภายใน <input
									id="answer_text_213A" name="answer_texts[2.1.3A]" type="text"
					...
					<div class="poll">
						...
						<h2>มีการจดแจ้งการครอบครองเชื้อโรคและพิษจากสัตว์ ตาม พรบ.
							เชื้อโรคและพิษจากสัตว์?</h2>
						<div class="choices">
							<div class="choice">
								...
								(โปรดแนบสำเนาหนังสือรับรองการจดแจ้งและรายการจดแจ้งตามแบบ จจ.ช.๑)
...
<a title="Download" class="fa fa-download"
								...
								<input type="hidden" name="tmpPath[2.1.4A]"
									value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "2.1.4A", "")?>">
<?php }?>
								</div>
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>มีห้องปฏิบัติการทางชีวภาพ จำนวน?</h2>
						<div class="choices">
							<div class="choice">
								...
								<br>BSL3 จำนวน<input id="answer_text_17"
									name="answer_texts[2.1.5.4]"
					...
					<div class="poll">
						...
						<h2>ส่วนงานมีการจัดทำเอกสารด้านความปลอดภัยทางชีวภาพ?</h2>
						<div class="choices">
							<div class="choice">
							...
							<div class="choice">
								...
								คาดว่าจะมีการดำเนินการเสร็จสิ้นภายใน <input
									id="answer_text_216A" name="answer_texts[2.1.6A]" type="text"
					...
					<div class="poll">
						...
						<h2>มีการเคลื่อนย้ายหรือขนส่งสารชีวภาพ/วัตถุชีวภาพ?</h2>
						<div class="choices">
							<div class="choice">
...
<a title="Download" class="fa fa-download"
								...
								<input type="hidden" name="tmpPath[2.1.7A]"
									value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "2.1.7A", "")?>">
<?php }?>
					...
					<div class="poll">
						...
						<h2>ผู้ที่ปฏิบัติงานในห้องปฏิบัติการทางชีวภาพได้รับการสร้างภูมิคุ้มกันต่อเชื้อที่ต้นปฏิบัติงานตามความเหมาะสม?</h2>
						<div class="choices">
							<div class="choice">
								<input type="radio" value="1" name="answers_choices[2.1.8A]"
									...
									id="answer_text_218A" name="answer_texts[2.1.8A]" type="text"
					...
					<!-- END -->
					<h4>1.2 การบริหารจัดการของเสียอันตรายชีวภาพ/ขยะติดเชื้อ</h4>
					<div class="poll">
						<div class="num">2.2.1</div>
						<h2>มีการแยกประเภทขยะ/ของเสียจากห้องปฏิบัติการทางชีวภาพ?</h2>
						<div class="choices">
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>มีการลดการปนเปื้นอและการจัดการของเสียทางชีวภาพ?</h2>
						<div class="choices">
							<div class="choice">
...
<a title="Download" class="fa fa-download"
								...
								<input type="hidden" name="tmpPath[2.2.2A]"
									value="<?php echo ConfigUtil::getAppName().''. QuestionUtil::getAnswerValue($answers, "4", "2.2.2A", "")?>">
<?php }?>
					...
					<div class="poll">
						...
						<h2>การส่งกำจัดของเสียอันตรายทางชีวภาพ/ขยะติดเชื้อ?</h2>
						<div class="choices">
							<div class="choice">
					...
					<h4>2.3
						การดำเนินงานโครงการที่ส่งเสริม/สนับสนุนงานด้านความปลดภัยทางชีวภาพ</h4>

					<div class="poll">
						<div class="num">2.3.1</div>
						<h2>มีการฝึกอบรมความปลอดภัยทางชีวภาพให้กับผู้ที่ปฏิบัติงานในห้องปฏิบัติการทางชีวภาพ?</h2>
						<div class="choices">
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>มีการทบทวนความรู้ด้านความปลอดภัยทางชีวภาพให้กับผู้ที่ปฏิบัติงานในห้องปฏิบัติการทางชีวภาพอย่างน้อยปีละ
							1 ครั้ง?</h2>
						<div class="choices">
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>โครงการ/การดำเนินงาน
							ที่ส่งเสริมและสนับสนุนงานด้านความปลดภัยทางชีวภาพ?</h2>
						<div class="choices">
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>ข้อบกพร่อง ปัญหา และอุปสรรคในการปฏิบัติงาน?</h2>
						<div class="choices">
							<div class="choice">
					...
					<div class="poll">
						...
						<h2>สรุปผลโครงการวิจัยด้านความปลอดภัยทางชีวภาพ ระดับ BSL1-3?</h2>
						<div class="choices">
							<div class="choice">
								ระดับ BSL 1 <input id="answers_text_40"
									...
									style="border: none; border-bottom-style: dotted;"> โครงการ <br>
								ระดับ BSL 2 <input id="answers_text_40"
									value="<?php echo QuestionUtil::getAnswerValue($answers, CommonUtil::TEXT_TYPE,"2.4.2", "") ?>"
									name="answer_texts[2.4.2]" type="text"
									style="border: none; border-bottom-style: dotted;"> โครงการ <br>
								ระดับ BSL 3 <input id="answers_text_40"
